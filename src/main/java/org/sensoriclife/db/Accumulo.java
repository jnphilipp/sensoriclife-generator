...
public class Accumulo {
	...
	public synchronized Iterator<Entry<Key,Value>> scannAll(String table) throws TableNotFoundException {
		return this.scannAll(table, "public");
	}

	public synchronized Iterator<Entry<Key,Value>> scannAll(String table, String visibility) throws TableNotFoundException {
